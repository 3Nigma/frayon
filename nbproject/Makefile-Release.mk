...
${OBJECTDIR}/src/AStarContainer.o: src/AStarContainer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AStarContainer.o src/AStarContainer.cpp

${OBJECTDIR}/src/AStarNode.o: src/AStarNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AStarNode.o src/AStarNode.cpp
...
${OBJECTDIR}/src/AnimationManager.o: src/AnimationManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AnimationManager.o src/AnimationManager.cpp

${OBJECTDIR}/src/AnimationSet.o: src/AnimationSet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AnimationSet.o src/AnimationSet.cpp

${OBJECTDIR}/src/Avatar.o: src/Avatar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Avatar.o src/Avatar.cpp

${OBJECTDIR}/src/BehaviorAlly.o: src/BehaviorAlly.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BehaviorAlly.o src/BehaviorAlly.cpp

${OBJECTDIR}/src/BehaviorStandard.o: src/BehaviorStandard.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BehaviorStandard.o src/BehaviorStandard.cpp

${OBJECTDIR}/src/CampaignManager.o: src/CampaignManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CampaignManager.o src/CampaignManager.cpp

${OBJECTDIR}/src/CombatText.o: src/CombatText.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CombatText.o src/CombatText.cpp

${OBJECTDIR}/src/EffectManager.o: src/EffectManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EffectManager.o src/EffectManager.cpp
...
${OBJECTDIR}/src/EnemyBehavior.o: src/EnemyBehavior.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EnemyBehavior.o src/EnemyBehavior.cpp

${OBJECTDIR}/src/EnemyGroupManager.o: src/EnemyGroupManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EnemyGroupManager.o src/EnemyGroupManager.cpp

${OBJECTDIR}/src/EnemyManager.o: src/EnemyManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EnemyManager.o src/EnemyManager.cpp
...
${OBJECTDIR}/src/FileParser.o: src/FileParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileParser.o src/FileParser.cpp

${OBJECTDIR}/src/FontEngine.o: src/FontEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FontEngine.o src/FontEngine.cpp
...
${OBJECTDIR}/src/GameStateConfig.o: src/GameStateConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameStateConfig.o src/GameStateConfig.cpp

${OBJECTDIR}/src/GameStateCutscene.o: src/GameStateCutscene.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameStateCutscene.o src/GameStateCutscene.cpp

${OBJECTDIR}/src/GameStateLoad.o: src/GameStateLoad.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameStateLoad.o src/GameStateLoad.cpp

${OBJECTDIR}/src/GameStateNew.o: src/GameStateNew.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameStateNew.o src/GameStateNew.cpp

${OBJECTDIR}/src/GameStatePlay.o: src/GameStatePlay.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameStatePlay.o src/GameStatePlay.cpp

${OBJECTDIR}/src/GameStateTitle.o: src/GameStateTitle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameStateTitle.o src/GameStateTitle.cpp

${OBJECTDIR}/src/GameSwitcher.o: src/GameSwitcher.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameSwitcher.o src/GameSwitcher.cpp

${OBJECTDIR}/src/GetText.o: src/GetText.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GetText.o src/GetText.cpp

${OBJECTDIR}/src/Hazard.o: src/Hazard.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Hazard.o src/Hazard.cpp

${OBJECTDIR}/src/HazardManager.o: src/HazardManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HazardManager.o src/HazardManager.cpp

${OBJECTDIR}/src/ImageManager.o: src/ImageManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ImageManager.o src/ImageManager.cpp

${OBJECTDIR}/src/InputState.o: src/InputState.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/InputState.o src/InputState.cpp

${OBJECTDIR}/src/ItemManager.o: src/ItemManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ItemManager.o src/ItemManager.cpp

${OBJECTDIR}/src/ItemStorage.o: src/ItemStorage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ItemStorage.o src/ItemStorage.cpp

${OBJECTDIR}/src/Loot.o: src/Loot.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Loot.o src/Loot.cpp

${OBJECTDIR}/src/LootManager.o: src/LootManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LootManager.o src/LootManager.cpp
...
${OBJECTDIR}/src/MapCollision.o: src/MapCollision.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MapCollision.o src/MapCollision.cpp

${OBJECTDIR}/src/MapRenderer.o: src/MapRenderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MapRenderer.o src/MapRenderer.cpp
...
${OBJECTDIR}/src/MenuActionBar.o: src/MenuActionBar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuActionBar.o src/MenuActionBar.cpp

${OBJECTDIR}/src/MenuActiveEffects.o: src/MenuActiveEffects.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuActiveEffects.o src/MenuActiveEffects.cpp

${OBJECTDIR}/src/MenuCharacter.o: src/MenuCharacter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuCharacter.o src/MenuCharacter.cpp

${OBJECTDIR}/src/MenuConfirm.o: src/MenuConfirm.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuConfirm.o src/MenuConfirm.cpp

${OBJECTDIR}/src/MenuEnemy.o: src/MenuEnemy.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuEnemy.o src/MenuEnemy.cpp

${OBJECTDIR}/src/MenuExit.o: src/MenuExit.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuExit.o src/MenuExit.cpp

${OBJECTDIR}/src/MenuHUDLog.o: src/MenuHUDLog.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuHUDLog.o src/MenuHUDLog.cpp

${OBJECTDIR}/src/MenuInventory.o: src/MenuInventory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuInventory.o src/MenuInventory.cpp

${OBJECTDIR}/src/MenuItemStorage.o: src/MenuItemStorage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuItemStorage.o src/MenuItemStorage.cpp

${OBJECTDIR}/src/MenuLog.o: src/MenuLog.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuLog.o src/MenuLog.cpp

${OBJECTDIR}/src/MenuManager.o: src/MenuManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuManager.o src/MenuManager.cpp

${OBJECTDIR}/src/MenuMiniMap.o: src/MenuMiniMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuMiniMap.o src/MenuMiniMap.cpp

${OBJECTDIR}/src/MenuNPCActions.o: src/MenuNPCActions.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuNPCActions.o src/MenuNPCActions.cpp

${OBJECTDIR}/src/MenuPowers.o: src/MenuPowers.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuPowers.o src/MenuPowers.cpp

${OBJECTDIR}/src/MenuStash.o: src/MenuStash.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuStash.o src/MenuStash.cpp

${OBJECTDIR}/src/MenuStatBar.o: src/MenuStatBar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuStatBar.o src/MenuStatBar.cpp

${OBJECTDIR}/src/MenuTalker.o: src/MenuTalker.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuTalker.o src/MenuTalker.cpp

${OBJECTDIR}/src/MenuVendor.o: src/MenuVendor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MenuVendor.o src/MenuVendor.cpp

${OBJECTDIR}/src/MessageEngine.o: src/MessageEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessageEngine.o src/MessageEngine.cpp

${OBJECTDIR}/src/ModManager.o: src/ModManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ModManager.o src/ModManager.cpp
...
${OBJECTDIR}/src/NPCManager.o: src/NPCManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NPCManager.o src/NPCManager.cpp

${OBJECTDIR}/src/PowerManager.o: src/PowerManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PowerManager.o src/PowerManager.cpp

${OBJECTDIR}/src/QuestLog.o: src/QuestLog.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QuestLog.o src/QuestLog.cpp

${OBJECTDIR}/src/SDL_gfxBlitFunc.o: src/SDL_gfxBlitFunc.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SDL_gfxBlitFunc.o src/SDL_gfxBlitFunc.c

${OBJECTDIR}/src/SaveLoad.o: src/SaveLoad.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SaveLoad.o src/SaveLoad.cpp
...
${OBJECTDIR}/src/SharedGameResources.o: src/SharedGameResources.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SharedGameResources.o src/SharedGameResources.cpp

${OBJECTDIR}/src/SharedResources.o: src/SharedResources.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SharedResources.o src/SharedResources.cpp

${OBJECTDIR}/src/SoundManager.o: src/SoundManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SoundManager.o src/SoundManager.cpp

${OBJECTDIR}/src/StatBlock.o: src/StatBlock.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StatBlock.o src/StatBlock.cpp
...
${OBJECTDIR}/src/TooltipData.o: src/TooltipData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TooltipData.o src/TooltipData.cpp
...
${OBJECTDIR}/src/UtilsDebug.o: src/UtilsDebug.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UtilsDebug.o src/UtilsDebug.cpp

${OBJECTDIR}/src/UtilsFileSystem.o: src/UtilsFileSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UtilsFileSystem.o src/UtilsFileSystem.cpp

${OBJECTDIR}/src/UtilsParsing.o: src/UtilsParsing.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UtilsParsing.o src/UtilsParsing.cpp

${OBJECTDIR}/src/Widget.o: src/Widget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Widget.o src/Widget.cpp

${OBJECTDIR}/src/WidgetButton.o: src/WidgetButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetButton.o src/WidgetButton.cpp

${OBJECTDIR}/src/WidgetCheckBox.o: src/WidgetCheckBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetCheckBox.o src/WidgetCheckBox.cpp

${OBJECTDIR}/src/WidgetInput.o: src/WidgetInput.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetInput.o src/WidgetInput.cpp

${OBJECTDIR}/src/WidgetLabel.o: src/WidgetLabel.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetLabel.o src/WidgetLabel.cpp

${OBJECTDIR}/src/WidgetListBox.o: src/WidgetListBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetListBox.o src/WidgetListBox.cpp

${OBJECTDIR}/src/WidgetScrollBar.o: src/WidgetScrollBar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetScrollBar.o src/WidgetScrollBar.cpp

${OBJECTDIR}/src/WidgetScrollBox.o: src/WidgetScrollBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetScrollBox.o src/WidgetScrollBox.cpp

${OBJECTDIR}/src/WidgetSlider.o: src/WidgetSlider.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetSlider.o src/WidgetSlider.cpp

${OBJECTDIR}/src/WidgetSlot.o: src/WidgetSlot.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetSlot.o src/WidgetSlot.cpp

${OBJECTDIR}/src/WidgetTabControl.o: src/WidgetTabControl.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetTabControl.o src/WidgetTabControl.cpp

${OBJECTDIR}/src/WidgetTooltip.o: src/WidgetTooltip.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WidgetTooltip.o src/WidgetTooltip.cpp
