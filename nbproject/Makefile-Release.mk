...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/frayon

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/frayon: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/frayon ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/3rdpt/LuaCppInterface/luacoroutine.o: 3rdpt/LuaCppInterface/luacoroutine.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/LuaCppInterface/luacoroutine.o 3rdpt/LuaCppInterface/luacoroutine.cpp

${OBJECTDIR}/3rdpt/LuaCppInterface/luacppinterface.o: 3rdpt/LuaCppInterface/luacppinterface.cpp 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/LuaCppInterface
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/LuaCppInterface/luacppinterface.o 3rdpt/LuaCppInterface/luacppinterface.cpp

${OBJECTDIR}/3rdpt/LuaCppInterface/luafunction.o: 3rdpt/LuaCppInterface/luafunction.cpp 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/LuaCppInterface
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/LuaCppInterface/luafunction.o 3rdpt/LuaCppInterface/luafunction.cpp

${OBJECTDIR}/3rdpt/LuaCppInterface/luareference.o: 3rdpt/LuaCppInterface/luareference.cpp 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/LuaCppInterface
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/LuaCppInterface/luareference.o 3rdpt/LuaCppInterface/luareference.cpp

${OBJECTDIR}/3rdpt/LuaCppInterface/luatable.o: 3rdpt/LuaCppInterface/luatable.cpp 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/LuaCppInterface
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/LuaCppInterface/luatable.o 3rdpt/LuaCppInterface/luatable.cpp

${OBJECTDIR}/3rdpt/lua5.2/lapi.o: 3rdpt/lua5.2/lapi.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lapi.o 3rdpt/lua5.2/lapi.c

${OBJECTDIR}/3rdpt/lua5.2/lauxlib.o: 3rdpt/lua5.2/lauxlib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lauxlib.o 3rdpt/lua5.2/lauxlib.c

${OBJECTDIR}/3rdpt/lua5.2/lbaselib.o: 3rdpt/lua5.2/lbaselib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lbaselib.o 3rdpt/lua5.2/lbaselib.c

${OBJECTDIR}/3rdpt/lua5.2/lbitlib.o: 3rdpt/lua5.2/lbitlib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lbitlib.o 3rdpt/lua5.2/lbitlib.c

${OBJECTDIR}/3rdpt/lua5.2/lcode.o: 3rdpt/lua5.2/lcode.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lcode.o 3rdpt/lua5.2/lcode.c

${OBJECTDIR}/3rdpt/lua5.2/lcorolib.o: 3rdpt/lua5.2/lcorolib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lcorolib.o 3rdpt/lua5.2/lcorolib.c

${OBJECTDIR}/3rdpt/lua5.2/lctype.o: 3rdpt/lua5.2/lctype.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lctype.o 3rdpt/lua5.2/lctype.c

${OBJECTDIR}/3rdpt/lua5.2/ldblib.o: 3rdpt/lua5.2/ldblib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ldblib.o 3rdpt/lua5.2/ldblib.c

${OBJECTDIR}/3rdpt/lua5.2/ldebug.o: 3rdpt/lua5.2/ldebug.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ldebug.o 3rdpt/lua5.2/ldebug.c

${OBJECTDIR}/3rdpt/lua5.2/ldo.o: 3rdpt/lua5.2/ldo.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ldo.o 3rdpt/lua5.2/ldo.c

${OBJECTDIR}/3rdpt/lua5.2/ldump.o: 3rdpt/lua5.2/ldump.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ldump.o 3rdpt/lua5.2/ldump.c

${OBJECTDIR}/3rdpt/lua5.2/lfunc.o: 3rdpt/lua5.2/lfunc.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lfunc.o 3rdpt/lua5.2/lfunc.c

${OBJECTDIR}/3rdpt/lua5.2/lgc.o: 3rdpt/lua5.2/lgc.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lgc.o 3rdpt/lua5.2/lgc.c

${OBJECTDIR}/3rdpt/lua5.2/linit.o: 3rdpt/lua5.2/linit.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/linit.o 3rdpt/lua5.2/linit.c

${OBJECTDIR}/3rdpt/lua5.2/liolib.o: 3rdpt/lua5.2/liolib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/liolib.o 3rdpt/lua5.2/liolib.c

${OBJECTDIR}/3rdpt/lua5.2/llex.o: 3rdpt/lua5.2/llex.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/llex.o 3rdpt/lua5.2/llex.c

${OBJECTDIR}/3rdpt/lua5.2/lmathlib.o: 3rdpt/lua5.2/lmathlib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lmathlib.o 3rdpt/lua5.2/lmathlib.c

${OBJECTDIR}/3rdpt/lua5.2/lmem.o: 3rdpt/lua5.2/lmem.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lmem.o 3rdpt/lua5.2/lmem.c

${OBJECTDIR}/3rdpt/lua5.2/loadlib.o: 3rdpt/lua5.2/loadlib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/loadlib.o 3rdpt/lua5.2/loadlib.c

${OBJECTDIR}/3rdpt/lua5.2/lobject.o: 3rdpt/lua5.2/lobject.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lobject.o 3rdpt/lua5.2/lobject.c

${OBJECTDIR}/3rdpt/lua5.2/lopcodes.o: 3rdpt/lua5.2/lopcodes.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lopcodes.o 3rdpt/lua5.2/lopcodes.c

${OBJECTDIR}/3rdpt/lua5.2/loslib.o: 3rdpt/lua5.2/loslib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/loslib.o 3rdpt/lua5.2/loslib.c

${OBJECTDIR}/3rdpt/lua5.2/lparser.o: 3rdpt/lua5.2/lparser.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lparser.o 3rdpt/lua5.2/lparser.c

${OBJECTDIR}/3rdpt/lua5.2/lstate.o: 3rdpt/lua5.2/lstate.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lstate.o 3rdpt/lua5.2/lstate.c

${OBJECTDIR}/3rdpt/lua5.2/lstring.o: 3rdpt/lua5.2/lstring.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lstring.o 3rdpt/lua5.2/lstring.c

${OBJECTDIR}/3rdpt/lua5.2/lstrlib.o: 3rdpt/lua5.2/lstrlib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lstrlib.o 3rdpt/lua5.2/lstrlib.c

${OBJECTDIR}/3rdpt/lua5.2/ltable.o: 3rdpt/lua5.2/ltable.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ltable.o 3rdpt/lua5.2/ltable.c

${OBJECTDIR}/3rdpt/lua5.2/ltablib.o: 3rdpt/lua5.2/ltablib.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ltablib.o 3rdpt/lua5.2/ltablib.c

${OBJECTDIR}/3rdpt/lua5.2/ltm.o: 3rdpt/lua5.2/ltm.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/ltm.o 3rdpt/lua5.2/ltm.c

${OBJECTDIR}/3rdpt/lua5.2/lua.o: 3rdpt/lua5.2/lua.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lua.o 3rdpt/lua5.2/lua.c

${OBJECTDIR}/3rdpt/lua5.2/luac.o: 3rdpt/lua5.2/luac.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/luac.o 3rdpt/lua5.2/luac.c

${OBJECTDIR}/3rdpt/lua5.2/lundump.o: 3rdpt/lua5.2/lundump.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lundump.o 3rdpt/lua5.2/lundump.c

${OBJECTDIR}/3rdpt/lua5.2/lvm.o: 3rdpt/lua5.2/lvm.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lvm.o 3rdpt/lua5.2/lvm.c

${OBJECTDIR}/3rdpt/lua5.2/lzio.o: 3rdpt/lua5.2/lzio.c 
	${MKDIR} -p ${OBJECTDIR}/3rdpt/lua5.2
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3rdpt/lua5.2/lzio.o 3rdpt/lua5.2/lzio.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/frayon
