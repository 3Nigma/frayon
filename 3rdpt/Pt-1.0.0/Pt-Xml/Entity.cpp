...
bool resolveHtmlEntity(Pt::String& entity)
{
    unsigned u = 0;
    ...
    while (o - u > 1)
    {
        ...
        if (c == 0)
        {
            entity = Pt::String(1, Pt::Char(ent[m].charValue));
            return true;
        }
        else if (c < 0)
            o = m;
    ...
    {
        entity = Pt::String(1, Pt::Char(ent[u].charValue));
        return true;
    }

    if (entity.compare(ent[o].entity) == 0)
    {
        entity = Pt::String(1, Pt::Char(ent[o].charValue));
        return true;
    }
